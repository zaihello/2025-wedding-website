...
<template>
  ...
  <section class="py-28 bg-white">
    <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row  md:items-start gap-10">
      ...
      <div class="w-full md:w-4/12 space-y-2 lg:text-left">
        <h3 class="text-l font-semibold text-cyan-500 uppercase [letter-spacing:6px]">about us</h3>
        ...
        <button class="inline-block bg-cyan-500 hover:bg-cyan-600 text-white font-bold
  ...
  <section class="py-24 bg-gray-100">
    ...
    <div class="text-center space-y-3 mb-10">
        <h3 class="text-l font-semibold text-cyan-500 uppercase [letter-spacing:6px]">wedding planner</h3>
      ...
      <div class="flex flex-col md:flex-row gap-2 ">
        ...
        <div class="w-full md:w-1/2 relative min-h-[530px] overlay-container">
          ...
          <div class="text-center text-white w-4/5  space-y-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            ...
            <button class="inline-block bg-cyan-500 hover:bg-cyan-600 text-white font-bold
                       py-3 px-6 rounded-3xl transition">Call Us Now</button>
          </div>
        </div>
        <!-- 右圖 -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div v-for="blogPost in blogPosts" :key="blogPost.id" class="space-y-2">
          <img 
            ...
            class=""
          >
          <h3 class="font-bold">{{ blogPost.title }}</h3>
          <div class="text-xs text-gray-700 ">
            by <a class="font-semibold">{{ blogPost.auther }}</a> | <span>{{ blogPost.date }}</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="relative min-h-[500px]">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white">
          ...
          <div> 
            <h3>send us</h3>
            <h2>Contact Info</h2>
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor em que, viva la vida penci wed.</p>
          </div>
          <!--  -->
          <div class="text-white flex flex-col">
            <div class="flex items-center space-x-4">
              ...
              <div class="flex-1 border-b border-white border-dashed"></div>
            </div>  
